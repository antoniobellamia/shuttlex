    ...
    <nav>
        <div class="pure-g">
            ...
            <div class="pure-u-md-1-2 pure-u-18-24" style="text-align: end;">
                <p class="c-margin-not"><?= date('d/m/Y H:i') ?> <br> <?= ($tipoGiorno ? "FESTIVO" : "FERIALE") ?></p>
            </div>
        </div>
        <div>
            ...
            <form class="pure-form pure-g" method="get" action="partenza.php">
                <div class="pure-u-3-5">
                   <select class="pure-input-1" name="fermata" required aria-placeholder="Fermata di partenza">
                        <option value="" disabled selected>Fermata di partenza</option>
                        <?php
                ...
                <button type="submit" class="cbutt button-small pure-button pure-input-1-5 pure-button-primary">Cerca</button>
                <button form="switch" type="submit" class="cbutt sec button-small pure-button pure-input-1-5 pure-button-secondary">
                    vedi <?php echo isset($tipoGiorno) && $tipoGiorno ? "FERIALE" : "FESTIVO"; ?>
                </button>

                <?php if(!isset($_GET["fermata"])) echo "
                <button form=\"showall\" type=\"submit\" class=\"cbutt sec button-small pure-button pure-input-1-5 pure-button-secondary\">
                   Tutti
                </button>"?>
            </form>
